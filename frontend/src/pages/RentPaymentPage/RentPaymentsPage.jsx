    ...
    <Box sx={{ display: "flex", height: "93.4vh", bgcolor: "#f5f6fa" }}>
      ...
      <Box sx={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
        ...
        <Box sx={{ p: 3, flexGrow: 1, overflowY: "auto", mt: 8 }}>
          ...
          {/* Filters */}
          <PaymentFilters filters={filters} onChange={handleFilterChange} onReset={handleResetFilters} />
      ...
      {/* Payment Modal */}
      <PaymentModal payment={selectedPayment} open={!!selectedPayment} onClose={handleClosePayment} onPay={handlePay} />
    </Box>
  );
}
