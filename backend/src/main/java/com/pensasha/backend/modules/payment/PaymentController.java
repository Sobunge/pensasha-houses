...
public class PaymentController {
        ...
        @PostMapping
        @PreAuthorize("hasAuthority('RENT_PAY') or hasRole('ADMIN')")
        ...
        @PreAuthorize("hasAuthority('RENT_CONFIRM_PAYMENT') or hasRole('ADMIN')")
        ...
        private EntityModel<Payment> toModel(Payment payment) {
                String invoiceId = payment.getInvoice() != null ? payment.getInvoice().getInvoiceNumber().toString()
                                : "null";
                return EntityModel.of(payment,
                                ...
                                WebMvcLinkBuilder
                                                .linkTo(WebMvcLinkBuilder.methodOn(PaymentController.class)
                                                                .getAllPayments(Pageable.unpaged()))
                                                .withRel("payments"),
                                WebMvcLinkBuilder
                                                .linkTo(WebMvcLinkBuilder.methodOn(PaymentController.class)
                                ...
                                WebMvcLinkBuilder
                                                .linkTo(WebMvcLinkBuilder.methodOn(PaymentController.class)
                                                                .assignInvoiceToPayment(payment.getId(),
