...
/**
 * Repository interface for accessing and managing {@link InvoiceSequence} entities.
 * 
...
public interface InvoiceSequenceRepository extends JpaRepository<InvoiceSequence, Long> {
    // No custom query methods are defined here — it inherits standard CRUD methods from JpaRepository.
}
