...
public class PropertyController {
    ...
    public ResponseEntity<?> updateProperty(
        ...
        // Create a HATEOAS response with links to the updated property and all properties
    ...
    public ResponseEntity<CollectionModel<EntityModel<PropertyDTO>>> getAllProperties() {
        ...
        // Create a HATEOAS response with a list of properties and a link to the properties collection
    ...
    public ResponseEntity<CollectionModel<EntityModel<PropertyDTO>>> getPropertiesByLandlord(
        ...
        // If no properties are found for the landlord, return a 204 (No Content) response
        if (properties.isEmpty()) {
            return ResponseEntity.noContent().build();
        }
        ...
        // Create a HATEOAS response with a list of properties and a link to the landlord's properties
        CollectionModel<EntityModel<PropertyDTO>> responseDTO = CollectionModel.of(propertyDTOs,
    ...
    public ResponseEntity<?> deleteProperty(@PathVariable Long id) {
        return propertyService.getProperty(id)
                ...
                .orElseGet(() -> ResponseEntity.status(HttpStatus.NOT_FOUND)
                        .body(Map.of("error", "Property not found")));  // Return 404 if property not found
    }
}
