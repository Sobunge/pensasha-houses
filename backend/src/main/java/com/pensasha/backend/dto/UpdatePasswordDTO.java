...
public class UpdatePasswordDTO {
    ...
    @Size(min = 8, message = "Password must be at least 8 characters")  // Ensures the current password is at least 8 characters long
    ...
    @Size(min = 8, message = "Password must be at least 8 characters")  // Ensures the new password is at least 8 characters long
    private String newPassword;

    // The confirmation of the new password, required to be non-blank and at least 8 characters
    @NotBlank(message = "Password is required")  // Ensures that the confirmation password is not blank
    @Size(min = 8, message = "Password must be at least 8 characters")  // Ensures the confirmation password is at least 8 characters long
